...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('template-body.html',
    '<div class="navigator row no-padding"><div class="col col-10 left-arrow" ng-click=prevMonth()><button class=button-clear><i class="icon icon-chevron icon-chevron-left ion-chevron-left"></i></button></div><div class="col col-80 view-month text-center">{{ monthsList[viewMonth] }} {{ viewYear }}</div><div class="col col-10" ng-click=nextMonth()><button class=button-clear><i class="icon icon-chevron icon-chevron-right ion-chevron-right"></i></button></div></div><label class="month-year-selector item item-input"><input type=month ng-model=monthYear.select ng-change=monthYearSelect()></label><div class=calendar-grid><div class=row><div class="col week-days" ng-class="{\'weekend\': ($index == 5 || $index == 6)}" ng-repeat="weekName in weekNames track by $index" ng-bind=weekName></div></div><div class=date-grid><div class="row date-row" ng-repeat="row in rows track by $index"><div class="col no-padding date-col" ng-repeat="col in cols track by $index" ng-class="{\'selected\': (dayList[row + $index].style.isSelected && accessType == \'WRITE\') , \'selected-light\': (dayList[row + $index].style.isSelected && accessType == \'READ\') , \'today\' : (dayList[row + $index].style.isToday) , \'weekend\': ((dayList[row + $index].day == 6 || dayList[row + $index].day == 0) && viewMonth == dayList[row + $index].month) , \'disabledDate\': (dayList[row + $index].style.isDisabled) , \'not-empty\': !(dayList[row + $index].style.isToday || dayList[row + $index].style.isSelected || dayList[row + $index].style.isDisabled) && (dayList[row + $index].style.isHoliday || dayList[row + $index].style.isCalendar1 || dayList[row + $index].style.isCalendar2 || dayList[row + $index].style.isCalendar3 || dayList[row + $index].style.isCalendar4 || dayList[row + $index].style.isCalendar5 || dayList[row + $index].style.isCalendar6 || dayList[row + $index].style.isCalendar7) , \'not-cur-month\': (!dayList[row + $index].style.isViewMonth)}"><div class=date-cell ng-click="dateSelected(dayList[row + $index], row)">{{ dayList[row + col].date }}</div><div class="holidays ng-hide" ng-class=holidaysClass ng-show="dayList[row + $index].style.isHoliday"></div><div class="calendar-1 ng-hide" ng-class=calendar1Class ng-show="dayList[row + $index].style.isCalendar1"></div><div class="calendar-2 ng-hide" ng-class=calendar2Class ng-show="dayList[row + $index].style.isCalendar2"></div><div class="calendar-3 ng-hide" ng-class=calendar3Class ng-show="dayList[row + $index].style.isCalendar3"></div><div class="calendar-4 ng-hide" ng-class=calendar4Class ng-show="dayList[row + $index].style.isCalendar4"></div><div class="calendar-5 ng-hide" ng-class=calendar5Class ng-show="dayList[row + $index].style.isCalendar5"></div><div class="calendar-6 ng-hide" ng-class=calendar6Class ng-show="dayList[row + $index].style.isCalendar6"></div><div class="calendar-7 ng-hide" ng-class=calendar7Class ng-show="dayList[row + $index].style.isCalendar7"></div></div></div></div></div><div class="calendar-names ng-hide" ng-show="namesCount > 0"><div class=calendars-point>date</div><div class="holiday-point ng-hide" ng-show="calendarNames[0].name.length > 0" ng-class=calendarNames[0].class>.</div><div class="calendar-1-point ng-hide" ng-show="calendarNames[1].name.length > 0" ng-class=calendarNames[1].class>.</div><div class="calendar-2-point ng-hide" ng-show="calendarNames[2].name.length > 0" ng-class=calendarNames[2].class>.</div><div class="calendar-3-point ng-hide" ng-show="calendarNames[3].name.length > 0" ng-class=calendarNames[3].class>.</div><div class="calendar-4-point ng-hide" ng-show="calendarNames[4].name.length > 0" ng-class=calendarNames[4].class>.</div><div class="calendar-5-point ng-hide" ng-show="calendarNames[5].name.length > 0" ng-class=calendarNames[5].class>.</div><div class="calendar-6-point ng-hide" ng-show="calendarNames[6].name.length > 0" ng-class=calendarNames[6].class>.</div><div class="calendar-7-point ng-hide" ng-show="calendarNames[7].name.length > 0" ng-class=calendarNames[7].class>.</div><div class=holiday-name>{{ calendarNames[0].name }}</div><div class=calendar-1-name>{{ calendarNames[1].name }}</div><div class=calendar-2-name>{{ calendarNames[2].name }}</div><div class=calendar-3-name>{{ calendarNames[3].name }}</div><div class=calendar-4-name>{{ calendarNames[4].name }}</div><div class=calendar-5-name>{{ calendarNames[5].name }}</div><div class=calendar-6-name>{{ calendarNames[6].name }}</div><div class=calendar-7-name>{{ calendarNames[7].name }}</div></div><div class=errors><div ng-repeat="error in errors">{{ error[errorLanguage] }}</div></div><div class="tgl-period ng-hide" ng-show="tglSelectByWeekShow && accessType == \'WRITE\' && selectType != \'SINGLE\'"><div class="item item-toggle" ng-class=titleSelectByWeekClass>{{ tglSelectByWeek }} <label class=toggle ng-class=tglSelectByWeekClass><input type=checkbox ng-model=selectByWeek.is><div class=track><div class=handle></div></div></label></div></div>');
}]);
})();
